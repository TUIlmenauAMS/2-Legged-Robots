...
(Here is a partial simulation for back and hip: https://colab.research.google.com/drive/190HttyWH3-cmfSE2mszep3_cSGHyP7G-?usp=sharing)

Here is a complete simulation of the somewhat creative robot that was generated by Grok Build from this repository, which sill shows the resulting walking motion from the interplay of physics and the Python program, with a nice user interface for trying it out. You can also drag the view:

https://earth-drift-prairie-falcon.grok.me/

Building the robot needs:
